...
/**
 * @description: 保存ajax提交的数据
 * @author: Weijie Zhou
 * @ProjectName: emos-api
 */
@Schema(description = "update user info form")
@Data
public class UpdateUserForm {

    @NotNull(message = "userId cannot be null")
    @Min(value = 1, message = "userIdcannot smaller than 1")
    ...
    @Pattern(regexp = "^[\\u4e00-\\u9fa5]{2,10}$", message = "name content incorrect")
