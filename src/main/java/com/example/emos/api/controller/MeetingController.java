...
public class MeetingController {
    ...
    @Operation(summary = "search offline meeting page form")
    @SaCheckLogin
    ...
    @SaCheckLogin
    public R deleteMeetingApplication(@Valid @RequestBody DeleteMeetingApplication form){
    ...
    @PostMapping("/searchRoomByIdByUUID")
    @Operation(summary = "查询会议房间RoomID")
    public R searchRoomByUUID(@Valid @RequestBody SearchRoomIdByUUIDForm form){
        Long roomId = meetingService.searchRoomIdUUID(form.getUuid());
